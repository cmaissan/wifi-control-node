(function() {
  ...
  module.exports = {
    ...
    getIfaceState: function() {
      var KEY, VALUE, connectionData, error, error1, error2, foundInterface, i, interfaceState, j, k, len, len1, ln, parsedLine, powerData, ref, ref1, ssid, ssidData;
      interfaceState = {};
      powerData = this.execSync("nmcli -terse -fields net-enabled nm");
      ...
      if (interfaceState.power) {
        ...
        ssidData = this.execSync("nmcli -m multiline device wifi list iface " + this.WiFiControlSettings.iface);
        ssid = null;
        ref1 = ssidData.split('\n');
    ...
    connectToAP: function(_ap) {
      ...
      try {
        stdout = this.execSync("nmcli connection list id \"" + _ap.ssid + "\"");
